...
void initRendering() {
    ...
    Image *image1 = loadBMP("cat1.bmp");
    Image *image2 = loadBMP("cat2.bmp");
    Image *image3 = loadBMP("cat3.bmp");
    Image *image4 = loadBMP("cat4.bmp");
    Image *image5 = loadBMP("cat5.bmp");
    Image *image6 = loadBMP("cat6.bmp");
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("Aniqah Nursabrina");
	initRendering();
